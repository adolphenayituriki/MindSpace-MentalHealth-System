...
const userSchema = new mongoose.Schema({
  ...
  role: { type: String, enum: ['user', 'counselor', 'admin', 'content_manager'], default: 'user' },
  ...
  relationshipStatus: { type: String, enum: ['single', 'engaged', 'married', 'divorced', 'widowed', 'separated', 'other'] },
  age: { type: Number },
  phone: { type: String },
  avatar: { type: String },
